        ...
        {step === 4 && (
          <section className="bg-white rounded-2xl shadow-xl p-8 mb-8 flex flex-col items-center animate-fade-in-up relative">
            ...
            <div className="flex gap-4 mt-4">
              ...
              <button onClick={() => router.push("/orders")} className="bg-emerald-100 text-emerald-800 font-bold px-8 py-3 rounded-xl shadow border border-emerald-200 transition-all text-lg flex items-center gap-2"><ArrowLeftIcon className="w-5 h-5" /> Track Order</button>
            </div>
